...
class RinContext:
    ...
    MAX_CONTEXT_TOKENS = 32768  # Llama-2 70B max context
    TOKEN_THRESHOLD = 26214     # 80% of max context (trigger summarization)
    SUMMARY_TOKEN_TARGET = 8192  # Target 25% for summary
    RETENTION_TOKEN_TARGET = 8192  # Target 25% for retained messages
